...
ggplot(plot_data, aes(x= factor(run), y= percent, fill= outcomes))+
  ...
  labs(x="course run",
       ...
       fill= "outcomes")
```
Figure 1 shows the percentage of learners who completed the course, unenrolled, or purchased a certificate across the seven runs. The percentage of Completion vary substantially between runs, ranging from approximately 0.5% to 12%. Run 1 records the highest completion rate at around 12% while few other runs show completion rates below 2%
